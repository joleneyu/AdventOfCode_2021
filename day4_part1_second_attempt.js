const boards = [
    ...
    function sumOfDrawNumber(list, row, column) {
        ...
        // let indexOfDrawNumber = SumOfIndex_column.indexOf(min_row)
    
        // let indexOfDrawNumber = 0
    
        if(min_row < min_column) {
            let indexOfDrawNumber = SumOfIndex_row.indexOf(min_row)
            console.log("nihao"+indexOfDrawNumber)
        } else {
            let indexOfDrawNumber = SumOfIndex_column.indexOf(min_column)
            console.log("hello"+indexOfDrawNumber)
        }
    ...
    sumOfDrawNumber(test_boards, 5, 5)
